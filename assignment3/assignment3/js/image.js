...
window.onload = function(){
    var myContainer = document.querySelector ("#images");
    var pics = "";

    for (var i = 0; i < images.length; i++){
        pics += "<figure><img src= '"+images[i].url+"' alt ='"+images[i].alt+"'>"+"<figcaption>"+images[i].caption+"</figcaption></figure>";
    }
    
    myContainer.innerHTML = pics;
};